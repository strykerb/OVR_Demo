...
namespace OVR.Exceptions
{
  public class MultipleOlfactoryException : Exception
  {
    public MultipleOlfactoryException()
    {
    }

    public MultipleOlfactoryException(string message)
        : base(message)
    {
    }

    public MultipleOlfactoryException(string message, Exception inner)
        : base(message, inner)
    {
    }
  }
